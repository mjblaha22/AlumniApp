...
class Events(models.Model):
    ...
    def __str__(self):
        return f"id={self.id}, user_id={self.user_id}, event_place={self.event_place}, event_place={self.event_place}, date_start={self.date_start}, time_start={self.time_start}, street_address={self.street_address}, state={self.state}, zipcode={self.zipcode}"
